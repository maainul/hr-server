// Invalid ID Formate
export const InvalidEmployeeID = 'Invalid Employee ID formate'
export const InvalidDepartmentID = 'Invalid Department ID formate'
export const InvalidDesignationID = 'Invalid Designation ID formate'
export const InvalidUnitID = 'Invalid Unit ID formate'
export const InvalidPolicyID = 'Invalid Policy ID formate'
export const InvalidLeaveTypeID = 'Invalid Leave Type ID formate'
...
// Not Exists
export const EmployeeNotExists = 'Employee Not Exists'
export const DepartmentNotExists = 'Department Not Exists'
export const DesignationNotExists = 'Designation Not Exists'
...
export const LeaveTypeNotExists = 'Leave Type Not Exists' 